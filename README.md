...
code and data associated to the manuscript titled "The origin of signal-preference divergence via social plasticity" by Camille Desjonquères, Bretta Speck, Sara Seidita, Lauren A. Cirino, Ignacio Escalante, Nathan W. Bailey, Rafael L. Rodríguez 
...
- Figure1_Table2_linearmodel.R is a script to fit the linear model, draw Figure 1 and obtain the statistics in Table 2
